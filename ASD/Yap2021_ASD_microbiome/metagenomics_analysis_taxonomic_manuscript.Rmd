...
- Removed taxa with <10 non-zero values (referred below here as "remove 0s") for some analyses 
    - Analyses with removal:
        ...
        - sPLS-DA (+ also apply offset = 1)
        - Linear models: ANOVA/mixed linear model (to include family pair information)/partially-overlapping t-tests on clr-transformed data
        - ANCOM
...
#summary(lm(shannon ~ participant_type_study, data = diversity_u10.df))
#summary(lm(shannon ~ participant_type_study + age + proforma_sex + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diversity_u10.df))
...
#summary(lm(shannon ~ participant_type, data = diversity_rarefy.df))
#anova(lm(shannon ~ participant_type, data = diversity_rarefy.df))
#summary(lm(shannon ~ participant_type + age + proforma_sex, data = diversity_rarefy.df))
#anova(lm(shannon ~ participant_type + age + proforma_sex, data = diversity_rarefy.df))
#summary(lm(shannon ~ participant_type + age + proforma_sex + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diversity_rarefy.df))
#anova(lm(shannon ~ participant_type + age + proforma_sex + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diversity_rarefy.df))
...
#summary(lm(shannon ~ participant_type, data = diversity_pairs.df))
#anova(lm(shannon ~ participant_type, data = diversity_pairs.df))
#summary(lm(shannon ~ participant_type + age + proforma_sex, data = diversity_pairs.df))
#anova(lm(shannon ~ participant_type + age + proforma_sex, data = diversity_pairs.df))
#summary(lm(shannon ~ participant_type + age + proforma_sex + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diversity_pairs.df))
#anova(lm(shannon ~ participant_type + age + proforma_sex + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diversity_pairs.df))
...
data_rm0_offset_clr.plsda <- plsda(data_rm0_offset_clr,
                          Y = Y,
                          ncomp = nlevels(Y),
                          logratio = "none")

data_rm0_offset_clr.perf.plsda = perf(data_rm0_offset_clr.plsda, validation = 'Mfold', folds = 5,
                    progressBar = FALSE, nrepeat = 10)

plot(data_rm0_offset_clr.perf.plsda, overlay = 'measure', sd=TRUE)
